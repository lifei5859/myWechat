	...
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'"
	 class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
			<!-- 后改 -->
			<view v-if="msgTime" class="uni-list-item-time-msg">
				{{ msgTime }}
			</view>
			...
			<view class="uni-list-item__content">
				<slot />
				<!-- 后改 -->
				<text :class="user? 'uni-list-item__user-content-title' : 'uni-list-item__content-title'">{{ title }}</text>
				<text v-if="note"  :class="user? 'uni-list-item__user-content-note' : 'uni-list-item__content-note'">{{ note }}</text>
			</view>
...
<style lang="scss" scoped>
	...
	.uni-list-item__user-content-title {
		font-size: 36upx;
	}
	...
	.uni-list-item__user-content-note {
		margin-top: 6rpx;
		color: $uni-text-color-grey;
		font-size: $uni-font-size-sm;
		overflow: hidden;
